...
\item MCU-program figures out the transform required to make a 289 by 289 image from the input image
...
\item Digits sent to MCU, where the sudoku is checked and result (and potentially other relevant info, incorrect rows etc.) is output to the user
\end{itemize}
\end{frame}
