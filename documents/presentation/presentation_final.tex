...
\begin{frame}{Binarized Neural Network}{A neural network}
\centering{
    \includegraphics[height=.7\textheight]{graphics/NN.pdf}
}
\end{frame}

\begin{frame}{Binarized Neural Network}{Inside one layer}
\centering{
    \includegraphics[width=\textwidth]{graphics/NNLayer.pdf}
}
\end{frame}

\begin{frame}{Binarized Neural Network}{Binarizing the activation function}
\centering{
    \includegraphics[width=\textwidth]{graphics/Activation.pdf}
}
\end{frame}

\begin{frame}{Binarized Neural Network}{Binarizing the normalization}
\centering{
    \includegraphics[width=\textwidth]{graphics/Normalization.pdf}
}
...
\centering{
    \includegraphics[width=\textwidth]{graphics/Splitting.pdf}
}
...
\centering{
    \includegraphics[width=\textwidth]{graphics/BNNv2.pdf}
}
\end{frame}
